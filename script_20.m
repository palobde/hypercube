...
% Definir k, rmin
k = 25; r_min = 5; r_max = k+1; %<-----------------A changer pour K
...
fic = fopen('RESULTATS_25.txt','w');  %<-----------------A changer pour K
fprintf(fic,'****************************************************\n');
...
%         sol_init=1; 
        ...
        if sol_init==0 % si on n'est pas entrain de charecher une nvelle solution initiale...
            ...
            while sortir==0
                ...
                x = testBase6(Base); x=round(x); nb_eval_sol=nb_eval_sol+1;
